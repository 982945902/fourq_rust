...
#error-- "Unsupported configuration"
    ...
    !defined(GENERIC_IMPLEMENTATION)
#error-- "Unsupported configuration"
#endif
...
typedef digit_t
    felm_t[NWORDS_FIELD];  // Datatype for representing 128-bit field elements
typedef felm_t
    f2elm_t[2];  // Datatype for representing quadratic extension field elements
...
#define ECCRYPTO_MSG_ERROR_SIGNATURE_VERIFICATION \
  "ECCRYPTO_ERROR_SIGNATURE_VERIFICATION"
